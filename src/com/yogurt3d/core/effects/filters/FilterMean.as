package com.yogurt3d.core.effects.filters
{
	...
	public class FilterMean extends Filter
	{		
		
		private var m_offset:Dictionary;
		
		public function FilterMean()
		{
		...
		public override function setShaderConstants(_context3D:Context3D,_veiwport:Rectangle):void{
			...
			_context3D.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 1,  Vector.<Number>([1.0/9.0, 0.0, 1.0, 1.0]));
