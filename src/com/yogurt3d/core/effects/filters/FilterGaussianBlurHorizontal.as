package com.yogurt3d.core.effects.filters
{
	...
	public class FilterGaussianBlurHorizontal extends Filter
	{
		...
		public function FilterGaussianBlurHorizontal()
		{
			super();	
		}
		...
		public override function setShaderConstants(_context3D:Context3D, _viewport:Rectangle):void{
			...
			// tc 
			_context3D.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 2,  Vector.<Number>([1.0, 0.0, 0.0, m_width]));
