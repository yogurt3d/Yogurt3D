package com.yogurt3d.core.materials.posteffects
{
	...
	public class FilterGaussianBlurVertical extends Filter
	{
		...
		public function FilterGaussianBlurVertical(_vxOff:Number, _width:Number, _height:Number)
		{
		...
		{			
			return ShaderUtils.fragmentAssambler.assemble( AGALMiniAssembler.FRAGMENT,
				[
					...
					"div ft3.xy ft3.xy fc3.z", // ft2 = vec2(0.0, offset[i])/rt_h 
					...
					"div ft3.xy ft3.xy fc3.z", // ft2 = vec2(0.0, offset[2])/rt_h 
