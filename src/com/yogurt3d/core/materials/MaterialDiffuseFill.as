...
package com.yogurt3d.core.materials
{
	 ...
	 * 
 	 ...
 	 **/
	public class MaterialDiffuseFill extends Material
	{
		private var lightShader:ShaderDiffuse;
		private var m_decalShader:ShaderSolidFill;
		private var m_ambientShader:ShaderAmbient;

		public function MaterialDiffuseFill( _color:uint = 0xFFFFFF, _opacity:Number = 1, _initInternals:Boolean=true)
		{
		...
		public function set opacity(_value:Number):void{
			...
			YOGURT3D_INTERNAL::m_transparent = (m_decalShader.opacity < 1);
		}
	}
}
