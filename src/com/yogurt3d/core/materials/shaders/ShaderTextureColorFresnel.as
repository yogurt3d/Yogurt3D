...
package com.yogurt3d.core.materials.shaders
{
	...
	public class ShaderTextureColorFresnel extends Shader
	{
		
		private var m_colorTexture					:ShaderConstants;
		 ...
		 **/
		public function ShaderTextureColorFresnel(_normalMap:TextureMap=null,  
												  _reflectivityMap:TextureMap=null,
												  _alpha:Number=1.0,
												  _fresnelReflectance:Number=0.028,
												  _fresnelPower:Number=5, 
												  _color1:uint=0xFFFFFF, 
												  _texture:TextureMap=null, _gain:Number=0.0)
		{
			key = "Yogurt3DOriginalsShaderTextureColorFresnel";
			...
			m_colorTexture.type						= EShaderConstantsType.TEXTURE;
			m_colorTexture.firstRegister			= 0; // FS0
			m_colorTexture.texture 					= m_texture;
			params.fragmentShaderConstants.push(m_colorTexture);
		...
		public override function getProgram(_context3D:Context3D, _lightType:ELightType=null, _meshType:String = null):Program3D{
			...
			key = "Yogurt3DOriginalsShaderTextureColorFresnel" + ((m_normalMap)?"WithNormal":"") + ((m_reflectivityMap)?"WithReflectivity":"") + ((m_normalMapUVOffset)?"WithNormalUVOffset":"") ;
