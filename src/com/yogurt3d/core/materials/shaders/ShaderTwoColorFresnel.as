...
package com.yogurt3d.core.materials.shaders
{
	...
	public class ShaderTwoColorFresnel extends Shader
	{
		
		private var m_alphaConsts					:ShaderConstants;
		private var m_fresnelConsts					:ShaderConstants;
		private var m_color1Consts					:ShaderConstants;
		private var m_color2Consts					:ShaderConstants;
		 ...
		 **/
		public function ShaderTwoColorFresnel( _normalMap:TextureMap=null,  
											_reflectivityMap:TextureMap=null,
											_alpha:Number=1.0,
											_fresnelReflectance:Number=0.028,
											_fresnelPower:Number=5, 
											_color1:uint=0xFFFFFF, _color2:uint=0xFF0000, _gain:Number=0.0)
		{
			key = "Yogurt3DOriginalsShader2ColorFresnel";
			...
			// fc4 : fresnel custom vector
			m_color1Consts   							= new ShaderConstants();
			m_color1Consts.type 						= EShaderConstantsType.CUSTOM_VECTOR;
			m_color1Consts.firstRegister				= 4;
			
			var _r:uint = m_color1 >> 16;
			var _g:uint = m_color1 >> 8 & 0xFF;
			var _b:uint = m_color1 & 0xFF;
			
			m_color1Consts.vector = Vector.<Number>([_r/255,_g/255,_b/255, m_alpha]);
	
			m_color1Consts.firstRegister				= 4;
			params.fragmentShaderConstants.push(m_color1Consts);
			
			
			// fc5 : fresnel custom vector
			m_color2Consts   							= new ShaderConstants();
			m_color2Consts.type 						= EShaderConstantsType.CUSTOM_VECTOR;
			m_color2Consts.firstRegister				= 5;
			
			_r = m_color2 >> 16;
			_g = m_color2 >> 8 & 0xFF;
			_b = m_color2 & 0xFF;
			
			m_color2Consts.vector = Vector.<Number>([_r/255,_g/255,_b/255, m_alpha]);
			params.fragmentShaderConstants.push(m_color2Consts);
		...
		public function set color2(_value:uint):void{
			...
			var _r:uint = m_color2 >> 16;
			var _g:uint = m_color2 >> 8 & 0xFF;
			var _b:uint = m_color2 & 0xFF;
		...
		public override function getVertexProgram(_meshKey:String, _lightType:ELightType = null):ByteArray{
			...
			return ShaderUtils.vertexAssambler.assemble(Context3DProgramType.VERTEX, _environmentalMappingVS);
		}
		...
		public override function getFragmentProgram(_lightType:ELightType=null):ByteArray{
			...
			return ShaderUtils.fragmentAssambler.assemble(Context3DProgramType.FRAGMENT, _environmentalMappingFS);
		}
		...
		public override function getProgram(_context3D:Context3D, _lightType:ELightType=null, _meshType:String = null):Program3D{
			...
			key = "Yogurt3DOriginalsShader2ColorFresnel" + ((m_normalMap)?"WithNormal":"") + ((m_reflectivityMap)?"WithReflectivity":"") + ((m_normalMapUVOffset)?"WithNormalUVOffset":"") ;
