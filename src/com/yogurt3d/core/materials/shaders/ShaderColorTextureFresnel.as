...
package com.yogurt3d.core.materials.shaders
{
	...
	public class ShaderColorTextureFresnel extends Shader
	{
		 ...
		 **/
		public function ShaderColorTextureFresnel(_normalMap:TextureMap=null,  
												 ...
												 _texture:TextureMap=null, _gain:Number=0.0)
		{
			...
			// fs0
			m_colorTexture 							= new ShaderConstants(0, EShaderConstantsType.TEXTURE);
			...
			m_color1Consts   							= new ShaderConstants(4, EShaderConstantsType.CUSTOM_VECTOR);
