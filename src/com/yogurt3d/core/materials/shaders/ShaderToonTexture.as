...
package com.yogurt3d.core.materials.shaders
{
	 ...
	 **/
	public class ShaderToonTexture extends Shader
	{
		private var textureConst:ShaderConstants;
		private var contColorConst:ShaderConstants;
								   ...
								   _opacity:Number = 1)
		{
			...
			textureConst								= new ShaderConstants(0, EShaderConstantsType.TEXTURE);
			textureConst.texture 						= m_texture;
			params.fragmentShaderConstants.push(textureConst);
			...
			_fragmentShaderConsts				 		= new ShaderConstants(5, EShaderConstantsType.CUSTOM_VECTOR);
			_fragmentShaderConsts.vector 				= Vector.<Number>([ 1.1, 0.7, _contourThickness, 0.2]);
			params.fragmentShaderConstants.push(_fragmentShaderConsts);
